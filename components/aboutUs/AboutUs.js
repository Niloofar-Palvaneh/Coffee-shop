    ...
    return (
        <>
            <div className="mt-32 flex items-center sm:flex-col md:flex-col xl:flex-col">
                ...
                className="bg-[url('/about-bg.jpg')] bg-center bg-cover p-12 self-stretch flex items-center justify-center">
                    <h3 className="font-bold text-2xl text-white leading-[60px] sm:text-center">
